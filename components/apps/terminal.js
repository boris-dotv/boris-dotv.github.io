...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "interests", "personal-documents"],
            projects: ["llm.v", "fintalk.v", "hku.rag.v", "soar", "Pendulum_Period_Analysis.v"],
            interests: ["LLM Alignment", "Multi-Agent Systems", "Long-Context Modeling", "Code Reasoning"],
        };
        this.state = {
            terminal: [],
        }
    ...
    handleCommands = async (command, rowId) => {
        ...
        switch (main) {
            ...
            case "sudo":
                ...
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, avril, chrome, about-boris, todoist, trash, settings, sendmsg ]";
        }
